...
- Remaining: the broader cleanup policy stays open around how much historical/model-specific cooldown residue to keep visible in the shared pool, and one seat still remains `missing_project_id`.
