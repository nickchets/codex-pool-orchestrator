...
- The next live boundary closed on 2026-03-27 as well: `T47` now blocks stale provider truth, `missing_project_id`, not-warmed restricted seats, quota pressure, and hard operational failure before Gemini selection, while startup stale-truth refresh re-hydrates ready Antigravity seats so the new gate does not collapse the pool after restart.
